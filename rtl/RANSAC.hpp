...
// RANSAC_FIND_BEST_EXIT:
    ...
    double GetParamThreshold(void) { return paramThreshold; }

    void SetParamRatio(double ratio = 0.95) { paramRatio = ratio; }

    double GetParamRatio(void) { return paramRatio; }
